...
public class ParallelStreams
{
   ...
   {
      String contents = new String(Files.readAllBytes(Paths.get("D:\\study\\spring-learning\\javabase\\target\\classes\\com\\tzm\\java\\stream\\alice30.txt")), StandardCharsets.UTF_8);
